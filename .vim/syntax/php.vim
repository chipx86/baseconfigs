...
if exists("php_no_html")
  syn match   phpPITag   "<?\(php\)\=" contained
  syn match   phpPITag   "?>"          contained
endif
...
if exists("php_parentError")
  ...
  if exists("php_no_html")
"    syn region    phpRegion      contains=@phpTop
     syn region  phpRegion      transparent start='^' end='$' contains=@phpTop
  else
...
if !exists("did_php_syntax_inits")
  ...
  hi             phpPITag      guifg=Red ctermfg=DarkRed
