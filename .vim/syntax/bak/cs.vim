...
syn keyword csPreproc		#if #else #elif #endif #define #undef #warning #error #line #region #endregion
...
syn region csRegionFold start="#region" end="#endregion" transparent fold
syn sync fromstart
