...
syn region p4changeFields
	...
	\ contains=p4changeLogImport,p4changeFieldName,p4changeSubField,
	           \p4changeMergeToField,p4changeComment
syn region p4changeFields
	\ start=/^Files:$/
	\ end=/^$/
...
syn region p4changeMergeToField oneline
	\ start=/\tMerge to: /
	\ end=/$/ contains=p4changeSubFieldName,p4changeBranchName,
	                  \p4changeMergeToValue
...
syn region p4changeSubField oneline
	...
	\ end=/$/ contains=p4changeSubFieldName,p4changePlaceholderValue,
	                  \p4changeValue

syn region p4changeFieldsFold start=/^\nChange:\t/ end=/\nDescription:$/me=s keepend transparent fold contains=p4changeComment,p4changeTopFields
...
syn match p4changeBranchName contained /[a-z][^:]\+: /
syn match p4changeMergeToValue contained /\(YES\|NO\|MANUAL\)/
syn match p4changePlaceholderValue contained /<required>/
...
hi def link p4changeBranchName Identifier
...
hi def link p4changeMergeToValue Constant
hi def link p4changePlaceholderValue TODO
