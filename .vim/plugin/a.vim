...
if (!exists("g:alternateExtensions_hh"))
   let alternateExtensions_{'hh'} = "c,cpp,cxx,cc,CC"
endif
...
if (!exists("g:alternateExtensions_cc"))
   let alternateExtensions_{'cc'} = "h,hh,hpp"
endif
...
if (!exists("g:alternateExtensions_ac"))
   let alternateExtensions_{'ac'} = "in"
endif

if (!exists("g:alternateExtensions_in"))
   let alternateExtensions_{'in'} = "ac"
endif
